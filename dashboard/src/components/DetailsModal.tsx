        ...
        >
            <div
                ...
                style={{
                    ...
                    borderRadius: "20px",
                    boxShadow:
                        "0 24px 80px rgba(139,92,246,0.15), 0 0 0 1px rgba(255,255,255,0.05)",
            ...
            >
                ...
                {/* Footer — fixed */}
                {footer && (
                    <div className="px-6 pb-5 pt-2 border-t border-white/[0.04] flex-shrink-0">
                        <p className="text-xs text-slate-500 text-center">{footer}</p>
                    </div>
                )}
            </div>
        </div>
